(function () {
  ...
  const targetRows = [
    ...
    ["福州烟台山商业漫步街区", "福州", "历史山地街区", "LCMR", "坡地/洋楼/咖啡/文创", "目标池"],
  ...
  const brandRows = [
    ...
    ["Jetlag Books", "上海", "文创书店艺术", "独立书店", "上海街区小店", "书店,独立出版,社区", "LCME,LCMR", "适合街巷、艺术园区和小体量文化商业。", "socialAuditNeeded"],
    ...
    ["没边boundless", "杭州", "国内设计师潮流买手", "年轻设计零售", "青年设计师品牌线索", "设计,年轻,买手", "LCMR,DCME,DCMR", "适合主理人零售、青年街区和快闪测试。", "socialAuditNeeded"],
